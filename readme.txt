...
* Add restrictions to settings action.
...
* Change initialization for better encapsulation.
* Change version check hook to a later instance.
* Change APL_Core to a single global instance.

= 0.5.3 =
* Fix notices action_index missing.

= 0.5.2 =
* Fix PHP Error in APL_Query.
* Add Filter to After List.
* Fix errors with admin notices.
* Add Filter to APL_Options defaults.
...
= 0.5.3 =
* Bug fix for admin notices.

= 0.5.2 =
* Bug fixes and additional extended support.
